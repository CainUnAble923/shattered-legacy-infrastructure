...
namespace Server.Mobiles
{
    ...
    public abstract partial class BaseGuildmaster : BaseVendor
    {
        ...
        /// <summary>
        /// Overridable hook called before vanilla speech handling. Return true to mark the event handled.
        /// Used by ClusterFGuildmasterExtension to open the guild join gump on custom phrases.
        /// </summary>
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from is PlayerMobile cpm && cpm.InRange(Location, 4) && OnCustomSpeech(cpm, e))
                e.Handled = true;
