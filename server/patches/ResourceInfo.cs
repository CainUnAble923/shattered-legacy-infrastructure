...
namespace Server.Items
{
    public enum CraftResource
    {
        ...
        // Shattered Legacy extended ores (Tiers 10-17)
        Platinum,
        Toxic,
        Blaze,
        Frost,
    ...
    public class CraftAttributeInfo
    {
        ...
        static CraftAttributeInfo()
        {
            ...
            // Platinum (T10) — Hardened silver ore. Physical + cold, enhanced durability.
            var platinum = Platinum = new CraftAttributeInfo();
            platinum.ArmorPhysicalResist = 5;
            platinum.ArmorColdResist     = 4;
            platinum.ArmorPoisonResist   = 3;
            platinum.ArmorEnergyResist   = 3;
            platinum.ArmorDurability     = 75;
            platinum.WeaponColdDamage    = 25;
            platinum.WeaponEnergyDamage  = 20;
            platinum.RunicMinAttributes  = 5;
            platinum.RunicMaxAttributes  = 5;
            platinum.RunicMinIntensity   = 88;
            platinum.RunicMaxIntensity   = 100;

            // Toxic (T11) — Corroded ore suffused with poison. Poison focus.
            var toxic = Toxic = new CraftAttributeInfo();
            toxic.ArmorPhysicalResist = 4;
            toxic.ArmorPoisonResist   = 7;
            toxic.ArmorColdResist     = 3;
            toxic.ArmorEnergyResist   = 3;
            toxic.ArmorDurability     = 50;
            toxic.WeaponPoisonDamage  = 50;
            toxic.WeaponEnergyDamage  = 10;
            toxic.RunicMinAttributes  = 5;
            toxic.RunicMaxAttributes  = 5;
            toxic.RunicMinIntensity   = 88;
            toxic.RunicMaxIntensity   = 100;

            // Blaze (T12) — Fire-infused volcanic ore. Fire and energy focus.
            var blaze = Blaze = new CraftAttributeInfo();
            blaze.ArmorPhysicalResist = 4;
            blaze.ArmorFireResist     = 6;
            blaze.ArmorColdResist     = 1;
            blaze.ArmorPoisonResist   = 3;
            blaze.ArmorEnergyResist   = 3;
            blaze.ArmorDurability     = 50;
            blaze.WeaponFireDamage    = 50;
            blaze.WeaponEnergyDamage  = 10;
            blaze.RunicMinAttributes  = 5;
            blaze.RunicMaxAttributes  = 5;
            blaze.RunicMinIntensity   = 88;
            blaze.RunicMaxIntensity   = 100;

            // Frost (T13) — Glacial ore from deep frozen veins. Cold focus, fire penalty.
            var frost = Frost = new CraftAttributeInfo();
            frost.ArmorPhysicalResist = 4;
            frost.ArmorFireResist     = -2;
            frost.ArmorColdResist     = 7;
            frost.ArmorPoisonResist   = 3;
            frost.ArmorEnergyResist   = 3;
            frost.ArmorDurability     = 75;
            frost.WeaponColdDamage    = 50;
            frost.RunicMinAttributes  = 5;
            frost.RunicMaxAttributes  = 5;
            frost.RunicMinIntensity   = 90;
            frost.RunicMaxIntensity   = 100;

            // Obsidian (T14) — Volcanic glass ore. Superior physical resistance and durability.
            var obsidian = Obsidian = new CraftAttributeInfo();
            obsidian.ArmorPhysicalResist = 6;
            obsidian.ArmorFireResist     = 4;
            obsidian.ArmorColdResist     = 2;
            obsidian.ArmorPoisonResist   = 3;
            obsidian.ArmorEnergyResist   = 3;
            obsidian.ArmorDurability     = 100;
            obsidian.WeaponFireDamage    = 30;
            obsidian.WeaponPoisonDamage  = 20;
            obsidian.RunicMinAttributes  = 5;
            obsidian.RunicMaxAttributes  = 5;
            obsidian.RunicMinIntensity   = 90;
            obsidian.RunicMaxIntensity   = 100;

            // Mythril (T15) — Magical ore attuned to energy and the arcane. Energy focus + luck.
            var mythril = Mythril = new CraftAttributeInfo();
            mythril.ArmorPhysicalResist = 4;
            mythril.ArmorFireResist     = 3;
            mythril.ArmorColdResist     = 4;
            mythril.ArmorPoisonResist   = 4;
            mythril.ArmorEnergyResist   = 6;
            mythril.ArmorLuck           = 50;
            mythril.ArmorDurability     = 75;
            mythril.WeaponEnergyDamage  = 50;
            mythril.WeaponLuck          = 50;
            mythril.RunicMinAttributes  = 5;
            mythril.RunicMaxAttributes  = 5;
            mythril.RunicMinIntensity   = 90;
            mythril.RunicMaxIntensity   = 100;

            // Adamantium (T16) — Nearly indestructible ore. Physical focus with massive durability.
            var adamantium = Adamantium = new CraftAttributeInfo();
            adamantium.ArmorPhysicalResist = 7;
            adamantium.ArmorFireResist     = 3;
            adamantium.ArmorColdResist     = 3;
            adamantium.ArmorPoisonResist   = 3;
            adamantium.ArmorEnergyResist   = 3;
            adamantium.ArmorDurability     = 150;
            adamantium.WeaponDurability    = 150;
            adamantium.WeaponFireDamage    = 20;
            adamantium.WeaponColdDamage    = 20;
            adamantium.RunicMinAttributes  = 5;
            adamantium.RunicMaxAttributes  = 5;
            adamantium.RunicMinIntensity   = 92;
            adamantium.RunicMaxIntensity   = 100;

            // Celestial (T17) — Divine ore of legend. All resists, all damage types, blessed luck.
            var celestial = Celestial = new CraftAttributeInfo();
            celestial.ArmorPhysicalResist = 6;
            celestial.ArmorFireResist     = 5;
            celestial.ArmorColdResist     = 5;
            celestial.ArmorPoisonResist   = 5;
            celestial.ArmorEnergyResist   = 5;
            celestial.ArmorLuck           = 60;
            celestial.ArmorDurability     = 100;
            celestial.WeaponFireDamage    = 15;
            celestial.WeaponColdDamage    = 15;
            celestial.WeaponPoisonDamage  = 15;
            celestial.WeaponEnergyDamage  = 15;
            celestial.WeaponLuck          = 60;
            celestial.RunicMinAttributes  = 5;
            celestial.RunicMaxAttributes  = 5;
            celestial.RunicMinIntensity   = 95;
            celestial.RunicMaxIntensity   = 100;
    ...
    public static class CraftResources
    {
        private static readonly CraftResourceInfo[] m_MetalInfo =
        {
            ...
            new(
                0x0413, // Dark charcoal
                0,
                "Adamantium",
                CraftAttributeInfo.Adamantium,
                CraftResource.Adamantium,
                typeof(AdamantiumIngot),
                typeof(AdamantiumOre)
            ),
            new(
                0x08AF, // Radiant gold
                0,
                "Celestial",
                CraftAttributeInfo.Celestial,
                CraftResource.Celestial,
                typeof(CelestialIngot),
                typeof(CelestialOre)
            )
        };
        ...
        public static CraftResourceType GetType(CraftResource resource) =>
            resource switch
            {
                >= CraftResource.Iron and <= CraftResource.Celestial                => CraftResourceType.Metal,
