// ServUO: Mobiles/Normal/EnslavedGoblinScout.cs (CC6 batch 1). Values verbatim (including the corpse name's article and the
...
public partial class EnslavedGoblinScout : BaseCreature
{
    ...
    public override string DefaultName => "Enslaved Goblin Scout";
