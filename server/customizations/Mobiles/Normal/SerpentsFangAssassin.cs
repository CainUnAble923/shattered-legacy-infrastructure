// ServUO: Mobiles/Normal/SerpentsFangAssassin.cs (CC6 batch 2). Values verbatim; serialization by the generator. The three
...
{
    [Constructible]
    public SerpentsFangAssassin() : base(AIType.AI_Melee)
    {
    ...
    public override string DefaultName => "Black Order Assassin";
