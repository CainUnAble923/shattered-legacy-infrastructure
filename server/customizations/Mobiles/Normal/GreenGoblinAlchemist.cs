// ServUO: Mobiles/Normal/GreenGoblinAlchemist.cs (CC6 batch 1). Values verbatim; serialization by the generator; ServUO's
...
{
    [Constructible]
    public GreenGoblinAlchemist() : base(AIType.AI_Melee)
    {
        Body = 723;
        BaseSoundID = 0x600;
    ...
    public override string DefaultName => "a green goblin alchemist";
