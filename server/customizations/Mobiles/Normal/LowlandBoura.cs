// ServUO: Mobiles/Normal/LowlandBoura.cs (CC6 batch 2). Values verbatim; serialization by the generator; the one
// persisted bool (GatheredFur, ServUO version 2) is a [SerializableField].
// Dropped: SetSpecialAbility(ColossalBlow) (D-53: Pet Training, declined B3, the Saurosaurus precedent); DragonBlood => 8 (D-50:
...
public partial class LowlandBoura : BaseCreature, ICarvable
{
    ...
    [Constructible]
    public LowlandBoura() : base(AIType.AI_Animal, FightMode.Aggressor)
    {
        Body = 715;
    ...
    public override string DefaultName => "a lowland boura";
    ...
    public FurType FurType => FurType.Green;
    ...
    public override void OnDeath(Container c)
    {
        ...
        // ServUO: `if (Controlled) return; if (!Controlled) DropItem` - the same thing said twice.
        if (!Controlled)
        {
