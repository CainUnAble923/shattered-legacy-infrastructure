...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Virtuosos/VirtuososCollar.cs (CC9 batch 4).
    ...
    public partial class VirtuososCollar : BaseSetArmor
    {
        [Constructible]
        public VirtuososCollar() : base(0x13C7)
        {
            Hue = 1374;
            StrRequirement = 20;
            SetHue = 1374;
        ...
        public override int LabelNumber => 1151555;
