...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Darkwood/DarkwoodGorget.cs (CC9 batch 4).
    // ServUO derives from WoodlandGorget and gets set/absorption state from BaseArmor. Here that state lives on
    // BaseSetArmor (S1), so the piece derives from that and reproduces stock WoodlandGorget's own members,
    ...
    public partial class DarkwoodGorget : BaseSetArmor
    {
        [Constructible]
        public DarkwoodGorget() : base(0x2B69)
        {
            Hue = 0x455;
            SetHue = 0x494;
        ...
        public override int LabelNumber => 1073483;
        ...
        // Stock WoodlandGorget members, reproduced because the parent changed.
