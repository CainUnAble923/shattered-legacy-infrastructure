...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Darkwood/DarkwoodGauntlets.cs (CC9 batch 4).
    // ServUO derives from WoodlandGloves and gets set/absorption state from BaseArmor. Here that state lives on
    // BaseSetArmor (S1), so the piece derives from that and reproduces stock WoodlandGloves's own members,
    // the way S1 did for the TigerPelt pieces under Aloron's set and CC9 batch 1 for the Greymist set.
    // [Flippable] is copied from WoodlandGloves: ModernUO reads it with inherit: false.
    ...
    public partial class DarkwoodGloves : BaseSetArmor
    {
        [Constructible]
        public DarkwoodGloves() : base(0x2B6A)
        {
            Hue = 0x455;
            SetHue = 0x494;
        ...
        public override int LabelNumber => 1073486;
        ...
        // Stock WoodlandGloves members, reproduced because the parent changed.
