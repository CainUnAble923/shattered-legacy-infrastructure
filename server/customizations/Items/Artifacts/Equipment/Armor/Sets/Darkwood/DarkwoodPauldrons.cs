...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Darkwood/DarkwoodPauldrons.cs (CC9 batch 4).
    // ServUO derives from WoodlandArms and gets set/absorption state from BaseArmor. Here that state lives on
    // BaseSetArmor (S1), so the piece derives from that and reproduces stock WoodlandArms's own members,
    ...
    public partial class DarkwoodPauldrons : BaseSetArmor
    {
        [Constructible]
        public DarkwoodPauldrons() : base(0x2B6C)
        {
            Hue = 0x455;
            SetHue = 0x494;
        ...
        public override int LabelNumber => 1073485;
        ...
        // Stock WoodlandArms members, reproduced because the parent changed.
