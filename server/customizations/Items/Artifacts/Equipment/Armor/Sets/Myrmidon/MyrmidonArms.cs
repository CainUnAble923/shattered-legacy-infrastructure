...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Myrmidon/MyrmidonArms.cs (CC9 batch 4).
    ...
    public partial class MyrmidonArms : BaseSetArmor
    {
        [Constructible]
        public MyrmidonArms() : base(0x13DC)
        {
            SetHue = 0x331;
