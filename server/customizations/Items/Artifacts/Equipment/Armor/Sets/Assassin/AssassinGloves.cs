...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Assassin/AssassinGloves.cs (CC9 batch 4).
    ...
    public partial class AssassinGloves : BaseSetArmor
    {
        [Constructible]
        public AssassinGloves() : base(0x13C6)
        {
            SetHue = 0x455;
