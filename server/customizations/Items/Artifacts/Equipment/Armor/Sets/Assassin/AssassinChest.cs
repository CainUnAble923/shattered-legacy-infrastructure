...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Assassin/AssassinChest.cs (CC9 batch 4).
    ...
    public partial class AssassinChest : BaseSetArmor
    {
        [Constructible]
        public AssassinChest() : base(0x13CC)
        {
            SetHue = 0x455;
