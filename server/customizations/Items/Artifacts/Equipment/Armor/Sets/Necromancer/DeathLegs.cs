...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Necromancer/DeathLegs.cs (CC9 batch 4).
    ...
    public partial class DeathLegs : BaseSetArmor
    {
        [Constructible]
        public DeathLegs() : base(0x13CB)
        {
            SetHue = 0x455;
