...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Necromancer/DeathGloves.cs (CC9 batch 4).
    ...
    public partial class DeathGloves : BaseSetArmor
    {
        [Constructible]
        public DeathGloves() : base(0x13C6)
        {
            SetHue = 0x455;
