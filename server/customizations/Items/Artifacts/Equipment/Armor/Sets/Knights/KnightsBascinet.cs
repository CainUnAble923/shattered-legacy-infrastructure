...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Knights/KnightsBascinet.cs (CC9 batch 4).
    ...
    public partial class KnightsBascinet : BaseSetArmor
    {
        [Constructible]
        public KnightsBascinet() : base(0x140C)
        {
            Hue = 1150;
        ...
        public override int LabelNumber => 1080159;
