...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Knights/KnightsPlateArms.cs (CC9 batch 4).
    ...
    public partial class KnightsPlateArms : BaseSetArmor
    {
        [Constructible]
        public KnightsPlateArms() : base(0x1410)
        {
            Hue = 1150;
        ...
        public override int LabelNumber => 1080162;
