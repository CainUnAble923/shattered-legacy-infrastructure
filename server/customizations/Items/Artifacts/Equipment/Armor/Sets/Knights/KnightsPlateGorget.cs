...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Knights/KnightsPlateGorget.cs (CC9 batch 4).
    ...
    public partial class KnightsPlateGorget : BaseSetArmor
    {
        [Constructible]
        public KnightsPlateGorget() : base(0x1413)
        {
            Hue = 1150;
        ...
        public override int LabelNumber => 1080160;
