...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Scout/ScoutChest.cs (CC9 batch 4).
    ...
    public partial class ScoutChest : BaseSetArmor
    {
        [Constructible]
        public ScoutChest() : base(0x13DB)
        {
            Hue = 1148;
        ...
        public override int LabelNumber => 1080476;
