...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Scout/ScoutCirclet.cs (CC9 batch 4).
    ...
    public partial class ScoutCirclet : BaseSetArmor
    {
        [Constructible]
        public ScoutCirclet() : base(0x2B6E)
        {
            Hue = 1148;
        ...
        public override int LabelNumber => 1080472;
