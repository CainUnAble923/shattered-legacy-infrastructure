...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Grizzle/GrizzleVambraces.cs (CC9 batch 4).
    ...
    public partial class GrizzleVambraces : BaseSetArmor
    {
        [Constructible]
        public GrizzleVambraces() : base(0x144E)
        {
            SetHue = 0x278;
        ...
        public override int LabelNumber => 1074470;
