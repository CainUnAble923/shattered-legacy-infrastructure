...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Bestial/BestialGorget.cs (CC9 batch 5).
    ...
    public partial class BestialGorget : BaseSetArmor
    {
        [Constructible]
        public BestialGorget() : base(0x13C7)
        {
            Hue = 2010;
            StrRequirement = 25;
        }
        ...
        public override int LabelNumber => 1151200;
