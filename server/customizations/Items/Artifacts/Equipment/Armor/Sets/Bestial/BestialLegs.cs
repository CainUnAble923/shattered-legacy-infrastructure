...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Bestial/BestialLegs.cs (CC9 batch 5).
    ...
    public partial class BestialLegs : BaseSetArmor
    {
        [Constructible]
        public BestialLegs() : base(0x13CB)
        {
            Hue = 2010;
            StrRequirement = 20;
        }
        ...
        public override int LabelNumber => 1151199;
