...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Sorcerers/SorcererArms.cs (CC9 batch 4).
    ...
    public partial class SorcererArms : BaseSetArmor
    {
        [Constructible]
        public SorcererArms() : base(0x13CD)
        {
            Hue = 1165;
        ...
        public override int LabelNumber => 1080467;
