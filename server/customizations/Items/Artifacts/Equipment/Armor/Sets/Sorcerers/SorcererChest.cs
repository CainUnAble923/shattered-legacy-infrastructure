...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Sorcerers/SorcererChest.cs (CC9 batch 4).
    ...
    public partial class SorcererChest : BaseSetArmor
    {
        [Constructible]
        public SorcererChest() : base(0x13CC)
        {
            Hue = 1165;
        ...
        public override int LabelNumber => 1080468;
