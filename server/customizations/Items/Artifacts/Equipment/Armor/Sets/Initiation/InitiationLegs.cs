...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Initiation/InitiationLegs.cs (CC9 batch 4).
    ...
    public partial class InitiationLegs : BaseSetArmor
    {
        [Constructible]
        public InitiationLegs() : base(0x13CB)
        {
            Hue = 0x9C4;
