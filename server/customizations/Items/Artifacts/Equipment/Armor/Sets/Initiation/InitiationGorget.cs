...
{
    // ServUO: Items/Artifacts/Equipment/Armor/Sets/Initiation/InitiationGorget.cs (CC9 batch 4).
    ...
    public partial class InitiationGorget : BaseSetArmor
    {
        [Constructible]
        public InitiationGorget() : base(0x13C7)
        {
            Hue = 0x9C4;
